...
export const B4X_BASECLASS_MEMBERS: Record<string, vscode.CompletionItem[]> = {
    "List": [
        {
            label: "Add",
            kind: vscode.CompletionItemKind.Method,
            detail: "Add(item As Object)",
        ...
        },
        {
            label: "AddAllAt",
            kind: vscode.CompletionItemKind.Method,
            detail: "AddAllAt(index As Int, list As List)",
        ...
        },
        {
            label: "Get",
            kind: vscode.CompletionItemKind.Method,
            detail: "Get(index As Int) As Object",
